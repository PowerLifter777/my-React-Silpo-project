...
const allProductCategories = [
    ...
    },
    {
        ...
        menu_level_2: {
            ...
            id: '3-2', path: "vareni-kovbasni-vyroby", name: "Варені ковбасні вироби", isSelected: false,
            id: '3-3', path: "kopcheni-kovbasni-vyroby", name: "Копчені ковбасні вироби", isSelected: false,
            id: '3-4', path: "tsilnom-iasni-vyroby", name: "Цільном'ясні вироби", isSelected: false,
            id: '3-5', path: "gotovi-vyroby-z-m-iasnykh-subproduktiv", name: "Готові вироби з м'ясних субпродуктів", isSelected: false,
    ...
    },
    {
        ...
        menu_level_2: {
            ...
            id: '5-4', path: "khlib", name: "Хліб", isSelected: false,
    ...
    },
    {
        ...
        menu_level_2: {
            id: '8-1', path: "yogurty-deserty", name: "Йогурти, десерти", isSelected: false,
            id: '8-2', path: "kyslomolochna-produktsiia", name: "Кисломолочна продукція", isSelected: false,
            id: '8-3', path: "moloko-vershky", name: "Молоко, вершки", isSelected: false,
            id: '8-4', path: "syr-kyslomolochnyi", name: "Сир кисломолочний", isSelected: false,
    ...
    },
    {
        ...
        menu_level_2: {
            id: '10-1', path: "oliia", name: "Олія", isSelected: false,
            id: '10-2', path: "makarony", name: "Макарони", isSelected: false,
            id: '10-3', path: "krupy", name: "Крупи", isSelected: false,
            ...
            id: '10-6', path: "vse-dlia-vypichky-ta-desertiv", name: "Все для випічки та десертів", isSelected: false,
            id: '10-7', path: "yizha-shvydkogo-prygotuvannia", name: "Їжа швидкого приготуваня", isSelected: false,
            id: '10-8', path: "gotovi-snidanky", name: "Готові сніданки", isSelected: false,
    ...
    },
    {
        ...
        menu_level_2: {
            ...
            id: '11-4', path: "ovocheva-konservatsiia", name: "Овочева консервація", isSelected: false,
            id: '11-5', path: "kukurudza-ta-goroshok", name: "Кукурудза та горошок", isSelected: false,
            id: '11-6', path: "olyvky", name: "Оливки", isSelected: false,
            id: '11-7', path: "m-iasna-konservatsiia", name: "М'ясна консервація", isSelected: false,
            id: '11-8', path: "rybna-konservatsiia", name: "Рибна консервація", isSelected: false,
            ...
            id: '11-12', path: "otset", name: "Оцет", isSelected: false,
            id: '11-13', path: "maionez", name: "Майонез", isSelected: false,
            id: '11-14', path: "ketchup-sous", name: "Кетчуп, соус", isSelected: false,
            id: '11-15', path: "khrin-girchytsia", name: "Хрін, гірчиця", isSelected: false,
            id: '11-16', path: "paniruvalni-sukhari", name: "Панірувальні сухарі", isSelected: false,
            id: '11-17', path: "prypravy-ta-spetsii", name: "Приправи та спеції", isSelected: false,
        }
    },
    {
        ...
        menu_level_2: {
            ...
            id: '12-5', path: "tsukerky", name: "Цукерки", isSelected: false,
            id: '12-6', path: "skhidni-solodoshchi", name: "Східні солодощі", isSelected: false,
            id: '12-7', path: "shokolad", name: "Шоколад", isSelected: false,
    ...
    },
    {
        ...
        menu_level_2: {
            ...
            id: '16-12', path: "pyvo", name: "Пиво", isSelected: false,
            id: '16-13', path: "slaboalkogolni-napoi", name: "Слабоалкогольні напої", isSelected: false,
        }
    },
    {
    ...
    },
    {
        ...
        menu_level_2: {
            id: '19-1', path: "dogliad", name: "Догляд", isSelected: false,
            id: '19-2', path: "dogliad-za-volossiam", name: "Догляд за волоссям", isSelected: false,
            id: '19-3', path: "dlia-golinnia-i-depiliatsii", name: "Для гоління й депіляції", isSelected: false,
            id: '19-4', path: "osobysta-gigiiena", name: "Особиста гігієна", isSelected: false,
            id: '19-5', path: "kosmetyka-i-parfumeriia", name: "Косметика і парфумерія", isSelected: false,
        }
    },
    {
        id: '20', img: icon_20, path: "dlia-domu", name: "Для дому", isSelected: false,
        menu_level_2: {
            id: '20-1', path: "pobutova-khimiia", name: "Побутова хімія", isSelected: false,
            id: '20-2', path: "paperovi-vyroby", name: "Паперові вироби", isSelected: false,
            id: '20-3', path: "gospodarchi-tovary", name: "Господарчі товари", isSelected: false,
            id: '20-4', path: "odnorazovyi-posud", name: "Одноразовий посуд", isSelected: false,
            id: '20-5', path: "kukhonne-pryladdia", name: "Кухонне приладдя", isSelected: false,
            id: '20-6', path: "inter-ier", name: "Інтер'єр", isSelected: false,
            id: '20-7', path: "odiag-ta-aksesuary", name: "Одяг та аксесуари", isSelected: false,
            id: '20-8', path: "khobi-ta-vidpochynok", name: "Хобі та відпочинок", isSelected: false,
        }
    },
    {
        id: '21', img: icon_21, path: "dytiachi-tovary", name: "Дитячі товари", isSelected: false,
        menu_level_2: {
            id: '21-1', path: "dytiache-kharchuvannia", name: "Дитяче харчування", isSelected: false,
            id: '21-2', path: "dogliad-ta-gigiiena", name: "Догляд та гігієна", isSelected: false,
