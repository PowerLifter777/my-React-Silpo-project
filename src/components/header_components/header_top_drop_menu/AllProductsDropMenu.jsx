...
const AllProductsDropMenu = () => {
    ...
    return (
        <div class="menu-wrapper">
            <div class="main-menu">
                <ul class="main-menu-levels level_1">
                            ...
                            <div class="main-menu-levels-wrapper">
                                <ul class="main-menu-levels level_2">
                                    ...
                                    <li class="" role="link" tabindex="0">
                                        <div>
                                            <a href="/category/gryby-svizhi-376">Гриби свіжі</a>
                                    ...
                                    <li class="" role="link" tabindex="0">
                                        <div>
                                            <a href="/category/zelen-377">Зелень</a>
                                            <i class="icon icon-chevron-right">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 12" width="7" height="12">
                                    ...
                                    <li class="active" role="link" tabindex="0">
                                        <div>
                                            <a href="/category/salat-379">Салат</a>
                                            <ul class="main-menu-levels level_3 visible">
                                                ...
                                                <li class="active" role="link" tabindex="0">
                                                    <div>
                                                        <a href="/category/rostky-399">Ростки</a>
                                                    </div>
                                                </li>
                                                <li class="" role="link" tabindex="0">
                                                    <div>
                                                        <a href="/category/salat-svizhyi-400">Салат свіжий</a>
                                                    </div>
                                                </li>
                                                <li class="" role="link" tabindex="0">
                                                    <div>
                                                        <a href="/category/salaty-gotovi-do-vzhyvannia-401">Салати, готові до вживання</a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="" role="link" tabindex="0">
                                        <div>
                                            <a href="/category/ovochi-378">Овочі</a>
                                            <i class="icon icon-chevron-right">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 12" width="7" height="12">
                                                    <path d="M1.2 12 0 10.8 4.6 6 0 1.2 1.2 0 7 6l-5.8 6z">
                                                    </path>
                                    ...
                                    <li class="" role="link" tabindex="0">
                                        <div>
                                            <a href="/category/frukty-381">Фрукти</a>
                                            <i class="icon icon-chevron-right">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 12" width="7" height="12">
                                                    <path d="M1.2 12 0 10.8 4.6 6 0 1.2 1.2 0 7 6l-5.8 6z"></path>
                                                </svg>
                                    ...
                                    <li class="" role="link" tabindex="0">
                                        <div>
                                            <a href="/category/fruktovi-delikatesy-380">Фруктові делікатеси</a>
                                        </div>
                                    </li>
                                    <li class="" role="link" tabindex="0">
                                        <div>
                                            <a href="/category/solinnia-marynovani-stravy-375">Соління, мариновані страви</a>
                                            <i class="icon icon-chevron-right">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 12" width="7" height="12">
                                                    <path d="M1.2 12 0 10.8 4.6 6 0 1.2 1.2 0 7 6l-5.8 6z"></path>
                                                </svg>
                                    ...
                                    <li class="" role="link" tabindex="0">
                                        <div>
                                            <a href="/category/susheni-frukty-gryby-gorikhy-382">Сушені фрукти, гриби, горіхи</a>
                                            <i class="icon icon-chevron-right">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 12" width="7" height="12">
                                                    <path d="M1.2 12 0 10.8 4.6 6 0 1.2 1.2 0 7 6l-5.8 6z">
                                                    </path>
