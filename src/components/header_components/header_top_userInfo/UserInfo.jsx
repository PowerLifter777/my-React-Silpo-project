...
import { ReactComponent as LocationSVG } from '../../../images/location_icon.svg'
import { ReactComponent as UserSVG } from '../../../images/user_icon.svg'
    ...
    return (
        <ul className={classes.userInfo}>
            <li title='Вхід/Реєстрація'>
                ...
                >
                    <UserSVG className={classes.userIcon}/>
